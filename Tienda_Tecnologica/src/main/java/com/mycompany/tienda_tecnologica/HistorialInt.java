...
public class HistorialInt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea4.setText("Historial");
        jScrollPane4.setViewportView(jTextArea4);

        jTextArea5.setColumns(20);
        jTextArea5.setRows(5);
        jTextArea5.setText("Historial");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistorialInt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistorialInt().setVisible(true);
            }
        });
    }
